...
## 8. Kesimpulan
Berdasarkan hasil analisis yang dilakukan pada website Shopee, dapat disimpulkan bahwa Shopee telah menerapkan protokol HTTPS dengan mekanisme SSL/TLS secara optimal untuk mengamankan pertukaran data antara pengguna dan server. Hal ini ditandai dengan munculnya ikon gembok pada bilah alamat serta penggunaan sertifikat digital yang valid dan diterbitkan oleh Certificate Authority (CA) yang tepercaya. Penerapan enkripsi ini berperan penting dalam melindungi informasi sensitif pengguna, seperti data akun dan transaksi pembayaran, dari risiko penyadapan maupun akses tidak sah, sehingga meningkatkan rasa aman dan kepercayaan pengguna dalam bertransaksi secara online.

Secara keseluruhan, hasil pengamatan dan pembahasan menunjukkan bahwa penerapan SSL/TLS dan kriptografi memiliki peranan krusial dalam menjaga keamanan serta kerahasiaan data pada komunikasi digital, khususnya pada layanan email dan e-commerce. Penggunaan HTTPS yang didukung oleh sertifikat digital mampu mencegah penyadapan dan manipulasi data selama proses komunikasi. Meskipun demikian, penerapan kriptografi juga menghadirkan tantangan dari sisi etika dan hukum, terutama terkait isu privasi, pengawasan, dan akses data oleh pihak berwenang. Oleh sebab itu, diperlukan kebijakan yang seimbang agar perlindungan keamanan data dapat berjalan tanpa mengesampingkan aspek hukum dan etika.
